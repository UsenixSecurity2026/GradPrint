...
Due to GitHub’s file-size limits, the full project (including the dataset and model weight files) is available on Zenodo: [https://zenodo.org/uploads/18513696].
